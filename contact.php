...
<head>
    ...
    <title>Hubungi Kami - electrons</title>
                ...
                <div class="row">
                    <div class="col-lg-5 offset-lg-1 col-md-12 order-1 order-lg-2">
                        <div class="contact-page-side-content">
                            <h3 class="contact-page-title">electrons</h3>
                            ...
                            <div class="single-contact-block">
                                ...
                                <p>Gang G. Sindoro 2 No.06 RT0/RW07, Ds. Menggung, Kelurahan Karangboyo, Kecamatan Cepu, Kabupaten Blora, Jawa Tengah, ID</p>
                            </div>
                            <div class="single-contact-block">
                            ...
                            <div class="single-contact-block last-child">
                                ...
                                <p><a href="mailto:electrons@cs.id">electrons@cs.id</a></p>
                            </div>
                        </div>
                    </div>
