                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="static-top-content mt-sm-30">
                            Promo Spesial Akhir Pekan dari <strong>electrons</strong> – Gunakan Kode Kupon:
                            <span>electrons2025</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <ul class="des">
                                    <li>
                                        <span>Alamat: </span>
                                        Gang G. Sindoro 2 No.06 RT0/RW07, Ds. Menggung, Kelurahan Karangboyo, Kecamatan Cepu, Kabupaten Blora, Jawa Tengah, ID
                                    </li>
                                    <li>
                                        <span>Telepon: </span>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="copyright text-center pt-25">
                                <span><a target="_blank" href="https://www.instagram.com/firlyfahriza/">Designed by: Firly Fahriza</a></span>
                            </div>
            ...
            function loadMiniCart() {
                fetch('get_cart_data.php')
                    ...
                    .then(data => {
                        ...
                        document.getElementById("minicart-subtotal").innerText = data.total;
                        document.querySelector(".cart-item-count").innerText = data.count;

                        const list = document.getElementById("minicart-list");
                        list.innerHTML = "";
                    ...
                    <a href="single-product.html" class="minicart-product-image">
                        <img src="images/product/small-size/${item.id}.jpg" alt="${item.name}">
                    </a>
                    <div class="minicart-product-details">
                ...
                `;
                    ...
                    .catch(err => console.error("Gagal muat mini cart:", err));
            }
